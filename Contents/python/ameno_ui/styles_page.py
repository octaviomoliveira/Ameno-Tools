...
class StylesPage(QtWidgets.QWidget):
    def __init__(self, bridge: UiBridge) -> None:
        ...
        self.style_card = QtWidgets.QFrame()
        self.style_card.setObjectName("Card")
        style_layout = QtWidgets.QVBoxLayout(self.style_card)
        style_layout.addWidget(SectionHeading("Estilo atual", "Escolha um estilo ou comece pelo padrão."))
        self.list_widget = QtWidgets.QListWidget()
        self.list_widget.setMinimumHeight(74)
        self.list_widget.currentRowChanged.connect(self._select_row)
        style_layout.addWidget(self.list_widget)
        style_buttons = QtWidgets.QHBoxLayout()
        ...
        style_buttons.addWidget(self.new_button, 1)
        style_buttons.addWidget(self.style_more)
        ...
        advanced_layout = QtWidgets.QVBoxLayout(advanced_host)
        ...
        advanced_layout.addWidget(line_box)
        advanced_layout.addWidget(terminal_box)
        self.advanced = Disclosure("Ajustes de linha e terminais", advanced_host, expanded=False)
        editor_layout.addWidget(self.advanced)
