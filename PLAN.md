...
- E4 implementada e aprovada em Batch isolado no 3ds Max 2026.3: o `MouseTool` conduz A/B/afastamento, atualiza uma prévia temporária, cria a cota permanente pelo construtor da E3 e cancela sem deixar nós.
...
- E4 — ferramenta de três cliques — pronta para teste manual no Max; E3 fechada com render comum validado nas condições informadas e limpeza aprovada.
