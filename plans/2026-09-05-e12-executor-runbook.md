...
- [ ] R3 draft válido e preview não-alvo — commit `83d9def` instalado, teste dedicado 28/28 e regressões aprovadas; gate de mouse real pendente. Handoff: `plans/2026-09-05-e12-r3-handoff.md`.
